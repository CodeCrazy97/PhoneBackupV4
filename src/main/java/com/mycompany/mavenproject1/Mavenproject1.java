...
public class Mavenproject1 extends javax.swing.JFrame {
    ...
    private void backupCallsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        String path
        ...
        if (!file.exists()) {
            ...
            try {
                ...
                Logger.getLogger(Mavenproject1.class.getName()).
            ...
            try {
                ...
                while (myReader.hasNextLine()) {
                    ...
                    JSONArray arr = obj.getJSONArray("listCallLogs");
                    int n = arr.length();
                    ...
                    for (int i = 0; i < n; ++i) {
                        ...
                        Contact contact = new Contact(name, d.getString("number"));
                        PhoneCall phoneCall = new PhoneCall(name, d.getString("number"), d.getLong("date"), d.getInt("duration"));

                        if (!contactExists(contacts, contact) && !contact.getName().isEmpty()) {
    ...
    private void filePathTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mavenproject1.class.getName()).
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mavenproject1 main = new Mavenproject1();
